...
public class Iti93ResponseConverter extends BasePMIRResponseConverter implements ToFhirTranslator<byte[]> {
    ...
    public Iti93ResponseConverter(final MagProps magProps) {
    ...
    public Bundle translateToFhir(byte[] input, Map<String, Object> parameters) {
        try {
            ...
            MCCIIN000002UV01Type msg = HL7V3Transformer.unmarshallMessage(MCCIIN000002UV01Type.class,
            ...
            source.setEndpoint(this.magProps.getBaseUrl());
            ...
            for (net.ihe.gazelle.hl7v3.mccimt000200UV01.MCCIMT000200UV01Acknowledgement akk : msg.getAcknowledgement()) {
                ...
                if (!code.getCode().equals("AA") && !code.getCode().equals("CA")) {
                    ...
                    for (MCCIMT000200UV01AcknowledgementDetail detail : akk.getAcknowledgementDetail()) {
                        ...
                        issue.setDetails(new CodeableConcept().setText(toText(detail.getText())).addCoding(transform(
                                detail.getCode())));
