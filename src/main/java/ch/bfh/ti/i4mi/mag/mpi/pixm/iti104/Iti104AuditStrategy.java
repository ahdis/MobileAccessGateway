...
public class Iti104AuditStrategy extends FhirAuditStrategy<Iti104AuditDataset> {
     ...
     */
    @Override
    protected EventOutcomeIndicator getEventOutcomeCodeFromResource(Iti104AuditDataset auditDataset, IBaseResource resource) {
    	if (! (resource instanceof Patient)) return super.getEventOutcomeCodeFromResource(auditDataset, resource);
