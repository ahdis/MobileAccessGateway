...
public class MagConstants {
    ...
    public static class FhirExtensionUrls {
        ...
        private static final String CH_PREFIX  = "http://fhir.ch/ig/ch-epr-fhir/StructureDefinition/";
        ...
        public static final String MOTHERS_MAIDEN_NAME    = MHD_PREFIX + "patient-mothersMaidenName";
