...
/**
 * ITI-18 responses sometimes lack the type classification for the SubmissionSet. This causes the SubmissionSets to get
 * lost during transformation from AdhocQueryResponse to QueryResponse
 *
